...
\begin{tikzpicture}[
  scale=1.0, bead/.style={circle, draw, fill=blue!20black!80, inner sep=3pt},
  ]
    ...
    % Draw the reachable workspace
    \draw[fill=gray, fill opacity=0.3] (0,0) ++(\Lout, 0) 
  arc (0:180:\Lout) ++(\TwoLtwo, 0) arc (180:0:\Linner);
\end{tikzpicture}
