...
\pgfmathsetmacro{\Tone}{1}
\pgfmathsetmacro{\Ttwo}{2}
\pgfmathsetmacro{\realpartone}{-1/\Tone}
\pgfmathsetmacro{\realparttwo}{-1/\Ttwo}
...
\begin{axis}[
   ...
   axis x line=center,
   axis y line=center,
   xtick={\realparttwo, \realpartone},
   xticklabels={$-\frac{1}{T_2}$, $-\frac{1}{T_1}$},
   ytick=\empty,
...
\node at (axis cs: \realpartone, 0) {\large $\times$};
\node at (axis cs: \realparttwo, 0) {\large $\times$};
